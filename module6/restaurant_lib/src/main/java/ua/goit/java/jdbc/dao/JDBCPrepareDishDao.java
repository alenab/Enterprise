...
public class JDBCPrepareDishDao implements PrepareDishDao {
    ...
    private PrepareDish createPrepareDish(ResultSet resultSet) throws SQLException {
        ...
        Dish dish = new JDBCDishDao().getById(resultSet.getInt("dish_id"));
        prepareDish.setDish(dish);
        Employee employee = new JDBCEmployeeDao().getById(resultSet.getInt("employee_id"));
        prepareDish.setEmployee(employee);
        Orders orders = new JDBCOrdersDao().getById(resultSet.getInt("order_id"));
